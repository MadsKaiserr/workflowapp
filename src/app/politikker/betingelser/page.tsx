    ...
    <>
      <div className="priser__hero__container">
        <div className="priser__hero__indhold">
          <h1 className="home__hero__h1">Workflows <span className="home__hero__h1__span">betingelser</span>.</h1>
          <p className="home__hero__p">Læs Workflows betingelser i sektionerne nedenfor</p>
