...
import { signup, singupWithGoogleComplete } from "../../lib"
...
export default function Form() {
    ...
    async function signupGoogle() {
        ...
        try {
            ...
            .then(async (result) => {
                ...
                await singupWithGoogleComplete(userData)
    ...
    return (
        <form className="logind__form" action={signupAction} onSubmit={() => handleSignup()}>
            <button className="google__logind__form__element__btn" type="button" onClick={() => signupGoogle()}>
            ...
            <div className="logind__form__element">
                ...
                <input className="logind__form__element__input" placeholder="eg. Jens Hansen" required name="name" value={formValues.name} onChange={handleInputChange} />
            </div>
            <div className="logind__form__element">
            ...
            <div className="login__cta__container">
                ...
                <p className="logind__form__element__policies">Ved at klikke &quot;Opret konto / Fortsæt&quot; accepterer du vores <Link href="/politikker/betingelser" className="logind__form__element__policies__link">Betingelser</Link> og <Link href="/politikker/privatlivspolitik" className="logind__form__element__policies__link">Privatlivspolitik</Link></p>
            </div>
        </form>
    );
}